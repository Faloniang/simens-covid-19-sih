...
class ConsultationForm extends Form {
	...
	public function __construct($name = null) {
		...
		$this->add ( array (
				...
				'type' => 'Text',
				'options' => array (
						'label' => iconv ( 'ISO-8859-1', 'UTF-8','Origine g�ographique'),
				),
				'attributes' => array (
		...
		$this->add ( array (
				...
				'type' => 'Textarea',
				'options' => array (
						'label' =>  iconv ( 'ISO-8859-1', 'UTF-8', "R�sum� de l'histoire de la maladie"),
				),
				'attributes' => array (
						'max' => 100,
						'min' => 0,
		...
		//********************Ant�c�dents ou Terrain particulier ******************
        //********************Ant�c�dents ou Terrain particulier ******************
        //********************Ant�c�dents ou Terrain particulier ****************** 
		...
		$this->add ( array (
				...
				'options' => array (
						'value_options' => array (
								0 => '',
								1 => iconv('ISO-8859-1', 'UTF-8', 'Diab�te de type 1'),
								2 => iconv('ISO-8859-1', 'UTF-8', 'Diab�te de type 2'),
								3 => iconv('ISO-8859-1', 'UTF-8', 'Diab�te gestationnel'),
								4 => iconv('ISO-8859-1', 'UTF-8', 'Diab�te secondaire'),
						)
				),
				'attributes' => array (
						'id' => 'type_diabetique',
		...
		$this->add ( array (
				...
				'options' => array (
						'value_options' => array (
								0 => '',
								1 => iconv('ISO-8859-1', 'UTF-8', 'M�tformine (Glucophage�)'),
		...
		$this->add ( array (
				...
				'options' => array (
						'value_options' => array (
								0 => '',
								1 => iconv('ISO-8859-1', 'UTF-8', 'Diab�tique'),
								2 => iconv('ISO-8859-1', 'UTF-8', 'Hyposod�'),
						)
				),
				'attributes' => array (
		...
		$this->add ( array (
				...
				'options' => array (
						'value_options' => array (
								...
								3 => iconv('ISO-8859-1', 'UTF-8', 'Diur�tique'),
								4 => iconv('ISO-8859-1', 'UTF-8', 'B�ta-bloquant'),
								5 => iconv('ISO-8859-1', 'UTF-8', 'Non trait�e'),
						)
				),
				'attributes' => array (
						'id' => 'hta_traitement',
		...
		$this->add ( array (
				...
				'options' => array (
						'value_options' => array (
								...
								3 => iconv('ISO-8859-1', 'UTF-8', 'Non trait�e'),
						)
				),
				'attributes' => array (
		...
		$this->add ( array (
				...
				'options' => array (
						'value_options' => array (
								0 => '',
								1 => iconv('ISO-8859-1', 'UTF-8', 'Amputation ou d�sarticulation'),
								2 => iconv('ISO-8859-1', 'UTF-8', 'Mise � plat (Abc�s et Phlegmons)'),
								3 => iconv('ISO-8859-1', 'UTF-8', 'N�crosectomie et assimil�s'),
						)
				),
				'attributes' => array (
		...
		$this->add ( array (
				...
				'options' => array (
						'value_options' => array (
								...
								2 => iconv('ISO-8859-1', 'UTF-8', 'Chirurgie pari�tale'),
		...
		$this->add ( array (
				...
				'options' => array (
						'value_options' => array (
								...
								2 => iconv('ISO-8859-1', 'UTF-8', 'Activit� physique diminu� mais autonome').' (Score = 1)',
								3 => iconv('ISO-8859-1', 'UTF-8', 'Incapacit� de mener une activit� normale ou travailler, mais alit� moins de 50% du temps').' (Score = 2)',
								4 => iconv('ISO-8859-1', 'UTF-8', 'Incapacit� de mener une activit� normale et alit� plus de 50% du temps').' (Score = 3)',
		...
		$this->add ( array (
				...
				'options' => array (
						'value_options' => array (
								0 => '',
								1 => iconv('ISO-8859-1', 'UTF-8', 'Normocolor�es'),
								2 => iconv('ISO-8859-1', 'UTF-8', 'P�les'),
								3 => iconv('ISO-8859-1', 'UTF-8', 'Ict�riques'),
						)
				),
				'attributes' => array (
						'id' => 'muqueuses',
		...
		/***
		 * LES Appareil d'appel ou syst�me --- Les Appareil d'appel ou syst�me
		 * LES Appareil d'appel ou syst�me --- Les Appareil d'appel ou syst�me
		 */
		...
		$this->add ( array (
				...
				'options' => array (
						'value_options' => array (
								 ...
								 4 => iconv('ISO-8859-1', 'UTF-8', 'Appareil uro-g�nital'),
								 5 => iconv('ISO-8859-1', 'UTF-8', 'Appareil musculo-squelettique'),
								 6 => iconv('ISO-8859-1', 'UTF-8', 'Appareil cutan�o-t�gumentaire'),
								 7 => iconv('ISO-8859-1', 'UTF-8', 'Appareil h�matopo��tique et glandulaire'),
								 8 => iconv('ISO-8859-1', 'UTF-8', 'Syst�me nerveux'),
						)
				),
				'attributes' => array (
		...
		$this->add ( array (
				...
				'options' => array (
						'value_options' => array (
								0 => '',
								1 => iconv('ISO-8859-1', 'UTF-8', 'Acido-c�tose'),
								2 => iconv('ISO-8859-1', 'UTF-8', 'Coma hyperosmolaire'),
								3 => iconv('ISO-8859-1', 'UTF-8', 'N�phropathie diab�tique'),
								4 => iconv('ISO-8859-1', 'UTF-8', 'R�tinopathie diab�tique'),
								5 => iconv('ISO-8859-1', 'UTF-8', 'Neuropathie p�riph�rique'),
								6 => iconv('ISO-8859-1', 'UTF-8', 'ACOMI'),
								7 => iconv('ISO-8859-1', 'UTF-8', 'AVC'),
								8 => iconv('ISO-8859-1', 'UTF-8', 'IDM'),
								9 => iconv('ISO-8859-1', 'UTF-8', 'Pied diab�tique'),
						)
				),
				'attributes' => array (
						'id' => 'complication',
